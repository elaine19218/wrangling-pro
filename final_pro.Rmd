...
```{r echo=FALSE}
print(paste("total number of users in March in 2019 and 2020 are:", nrow(dat19), nrow(dat20)))
```
...
From the plot, we can easily see that stations on the same hot streets in 2020 are used less frequently than in 2019.
```{r}
##19
